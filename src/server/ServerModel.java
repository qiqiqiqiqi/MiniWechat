...
public class ServerModel extends Observable {
	...
	private static Logger logger = Logger.getLogger(ServerModel.class);
...
//		init();
	...
	public void addClientUserToTable(IoSession ioSession, ClientUser clientUser) throws NoIpException {
		logger.info("addClientUserToTable():clientUserIpTable="+clientUserIpTable);
	...
	public void clientUserLogin(ClientUser clientUser, String userId) {
		...
		logger.info("clientUserIdTable="+clientUserIdTable);
	}
	...
	public void clientUserLogout(ClientUser clientUser) {
		logger.info("clientUserLogout():clientUser="+clientUser);
		try {
...
//			clientUser.userId = null;
	...
	public static String getIoSessionKey(IoSession ioSession) throws NoIpException  {
		...
		logger.info("getIoSessionKey():ioSession.getIoSessionKey()="+((InetSocketAddress) ioSession.getRemoteAddress()).getAddress().toString() + ":"

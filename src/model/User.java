...
//	public static final String TABLE_NAME = User.class.getSimpleName();
    ...
    @Id
    @Column(name="user_id",columnDefinition = "char(32)  COMMENT '微信号'")
	...
	@Column(name="user_creatTime",columnDefinition = "BIGINT(8)  COMMENT '创建时间'")
	...
	@ManyToMany(targetEntity = Group.class, cascade = { CascadeType.PERSIST, CascadeType.MERGE },fetch=FetchType.EAGER)
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", userPassword=" + userPassword + ", headIndex="
				+ headIndex + ", creatTime=" + creatTime +  ", groups=" + groups + "]";
	}

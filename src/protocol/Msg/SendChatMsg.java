...
public final class SendChatMsg {
  ...
  public static final class SendChatReq extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return protocol.Msg.SendChatMsg.internal_static_protocol_SendChatReq_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return protocol.Msg.SendChatMsg.internal_static_protocol_SendChatReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              protocol.Msg.SendChatMsg.SendChatReq.class, protocol.Msg.SendChatMsg.SendChatReq.Builder.class);
    }
    ...
    public static protocol.Msg.SendChatMsg.SendChatReq parseFrom(
    ...
    public static protocol.Msg.SendChatMsg.SendChatReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static protocol.Msg.SendChatMsg.SendChatReq parseFrom(
    ...
    public static protocol.Msg.SendChatMsg.SendChatReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static protocol.Msg.SendChatMsg.SendChatReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static protocol.Msg.SendChatMsg.SendChatReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(protocol.Msg.SendChatMsg.SendChatReq prototype) {
    ...
    public static final class Builder extends
        ...
        protocol.Msg.SendChatMsg.SendChatReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return protocol.Msg.SendChatMsg.internal_static_protocol_SendChatReq_descriptor;
      }
      ...
      // Construct using protocol.Msg.SendChatMsg.SendChatReq.newBuilder()
      private Builder() {
      ...
      public protocol.Msg.SendChatMsg.SendChatReq getDefaultInstanceForType() {
        return protocol.Msg.SendChatMsg.SendChatReq.getDefaultInstance();
      }

      public protocol.Msg.SendChatMsg.SendChatReq build() {
        protocol.Msg.SendChatMsg.SendChatReq result = buildPartial();
      ...
      public protocol.Msg.SendChatMsg.SendChatReq buildPartial() {
        protocol.Msg.SendChatMsg.SendChatReq result = new protocol.Msg.SendChatMsg.SendChatReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof protocol.Msg.SendChatMsg.SendChatReq) {
          return mergeFrom((protocol.Msg.SendChatMsg.SendChatReq)other);
        } else {
      ...
      public Builder mergeFrom(protocol.Msg.SendChatMsg.SendChatReq other) {
        if (other == protocol.Msg.SendChatMsg.SendChatReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        protocol.Msg.SendChatMsg.SendChatReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (protocol.Msg.SendChatMsg.SendChatReq) e.getUnfinishedMessage();
          throw e;
        } finally {
  ...
  public interface SendChatRspOrBuilder extends
     ...
     * <code>required .protocol.SendChatRsp.ResultCode resultCode = 1;</code>
     */
    protocol.Msg.SendChatMsg.SendChatRsp.ResultCode getResultCode();
  ...
  public static final class SendChatRsp extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              protocol.Msg.SendChatMsg.SendChatRsp.ResultCode value = protocol.Msg.SendChatMsg.SendChatRsp.ResultCode.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return protocol.Msg.SendChatMsg.internal_static_protocol_SendChatRsp_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return protocol.Msg.SendChatMsg.internal_static_protocol_SendChatRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              protocol.Msg.SendChatMsg.SendChatRsp.class, protocol.Msg.SendChatMsg.SendChatRsp.Builder.class);
    }
    ...
    public enum ResultCode
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return protocol.Msg.SendChatMsg.SendChatRsp.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private protocol.Msg.SendChatMsg.SendChatRsp.ResultCode resultCode_;
    /**
     * <code>required .protocol.SendChatRsp.ResultCode resultCode = 1;</code>
     */
     ...
     * <code>required .protocol.SendChatRsp.ResultCode resultCode = 1;</code>
     */
    public protocol.Msg.SendChatMsg.SendChatRsp.ResultCode getResultCode() {
      return resultCode_;
    }
    ...
    private void initFields() {
      resultCode_ = protocol.Msg.SendChatMsg.SendChatRsp.ResultCode.SUCCESS;
      messageInfoID_ = "";
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        output.writeBytes(2, getMessageInfoIDBytes());
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(2, getMessageInfoIDBytes());
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
    ...
    public static protocol.Msg.SendChatMsg.SendChatRsp parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static protocol.Msg.SendChatMsg.SendChatRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static protocol.Msg.SendChatMsg.SendChatRsp parseFrom(
    ...
    public static protocol.Msg.SendChatMsg.SendChatRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static protocol.Msg.SendChatMsg.SendChatRsp parseFrom(
    ...
    public static protocol.Msg.SendChatMsg.SendChatRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static protocol.Msg.SendChatMsg.SendChatRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(protocol.Msg.SendChatMsg.SendChatRsp prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        ...
        protocol.Msg.SendChatMsg.SendChatRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return protocol.Msg.SendChatMsg.internal_static_protocol_SendChatRsp_descriptor;
      }
      ...
      // Construct using protocol.Msg.SendChatMsg.SendChatRsp.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public protocol.Msg.SendChatMsg.SendChatRsp getDefaultInstanceForType() {
        return protocol.Msg.SendChatMsg.SendChatRsp.getDefaultInstance();
      }

      public protocol.Msg.SendChatMsg.SendChatRsp build() {
        protocol.Msg.SendChatMsg.SendChatRsp result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public protocol.Msg.SendChatMsg.SendChatRsp buildPartial() {
        protocol.Msg.SendChatMsg.SendChatRsp result = new protocol.Msg.SendChatMsg.SendChatRsp(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof protocol.Msg.SendChatMsg.SendChatRsp) {
          return mergeFrom((protocol.Msg.SendChatMsg.SendChatRsp)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(protocol.Msg.SendChatMsg.SendChatRsp other) {
        if (other == protocol.Msg.SendChatMsg.SendChatRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        protocol.Msg.SendChatMsg.SendChatRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (protocol.Msg.SendChatMsg.SendChatRsp) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private protocol.Msg.SendChatMsg.SendChatRsp.ResultCode resultCode_ = protocol.Msg.SendChatMsg.SendChatRsp.ResultCode.SUCCESS;
      /**
       * <code>required .protocol.SendChatRsp.ResultCode resultCode = 1;</code>
       */
      public boolean hasResultCode() {
       ...
       * <code>required .protocol.SendChatRsp.ResultCode resultCode = 1;</code>
       */
      public Builder setResultCode(protocol.Msg.SendChatMsg.SendChatRsp.ResultCode value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000001;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "proto\"3\n\013SendChatReq\022$\n\010chatData\030\001 \002(\0132\022" +
      ".protocol.ChatItem\"\177\n\013SendChatRsp\0224\n\nres" +
      "ultCode\030\001 \002(\0162 .protocol.SendChatRsp.Res" +
